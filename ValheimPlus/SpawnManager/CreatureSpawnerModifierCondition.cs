...
{
    [Serializable]
    public class CreatureSpawnerModifierCondition : IZPackageable
    {
        ...
        public bool IsValid()
        {
            return  (MatchingNames != null && MatchingNames.Count > 0) || // valid for matching specific object names (i.e SpawnSystem,SpawnArea, or CreatureSpawner object name)
                    (MatchingObjectNames != null && MatchingObjectNames.Count > 0) || // valid for matching specific object names
